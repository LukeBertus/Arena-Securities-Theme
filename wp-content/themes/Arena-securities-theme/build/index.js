...
class Like {
  ...
  ourClickDispatcher(e) {
    likeBox.attr('data-exists') == 'yes' ? this.deleteLike(likeBox) : this.createLike(likeBox);
  }
  createLike(likeBox) {
      ...
      success: response => {
        ...
        jquery__WEBPACK_IMPORTED_MODULE_0___default()(`
                <li data-id="${response.id}">
                    <input readonly value="${response.title.rendered.replace('Private: ', '')}" class="note-title-field" type="text">
      ...
      this.resultsDiv.html(`
            <div class="row">
                ...
                <div class="one-third">
                    ...
                    ${results.campuses.length ? '<ul class="link-list min-list">' : `<p>No campus information matches that search. <a href="${universityData.root_url}/campuses">View all campuses</a></p>`}
  ...
  typingLogic() {
    if (this.searchField.val() !== this.previousValue) {
      ...
      if (this.searchField.val() !== "") {
        // Checks spinner visibility to avoid recreating div
